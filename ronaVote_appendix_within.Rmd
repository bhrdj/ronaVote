...
#### Most states have enough counties, but some have too few. 
...
```
#### Declare a Function for "within" regressions
```{r warning=FALSE, message=FALSE}
...
#### Run and plot coefficients "between" regression.  
...
```
#### Run and plot "within" (FE) regression coefficient as time series.
...
#### Combining the "between" and "within" coefficient plots
