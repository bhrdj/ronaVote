...
## Abstract
<br>
In Spring and Summer of 2020, predominantly politically Democratic counties suffered the worst of the first COVID wave. But after the Fall and the election passed, the winter saw much worse COVID in Republican-leaning counties.
...
*To date, Republican areas have accumulated more COVID overall.*
<br><br>
...
<div class="center_plots">
#### Time Series Plot of Linear Regression Coefficients
<br>
...
Overall in the USA today, one in ten USA residents has tested positive for COVID. So, an additional 2 out of ten thousand represents a 0.2% difference in the total level of cumulative COVID cases. On 2021-08-08, the R² is 0.054 and the p-value on is 3E-39.
...
# Calc USA Aggregate COVID Data Per-1000 Population
ronaPer1000USA <- ronaTotalUSA * 1000 / nationalSummaries["pop2019"] 
...
ts_subtitle = "(Between Per-100k COVID and 2020 Vote Margin Across USA Counties)"
ts_caption = paste(
...
<!-- Consider an example county with 100,000 Americans, including 50,000 voters, and a coefficient of +20, where areas that voted more-Republican tend to have accumulated more COVID cases. -->

<!-- If the county were to hypothetically move along this margin such that there were 2,500 more Republican votes and 2,500 fewer Democrat votes, then that would increase the margin by +0.10, corresponding to +200 additional cases in the county. While that sounds like a lot, and would matter to those people, it's a relatively small magnitude.  -->
