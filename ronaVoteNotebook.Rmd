...
<div class="center_plots">
<br>
<img  src="./png/withinBetween_2021-08-16.png">
<br>
</div>

<div class="center_plots">
<br>
<img  src="./png/stateByState_2021-08-16.png">
<br>
</div>
...
pathRona <- "./data/rona/NYT/us-counties_2021-08-16.csv"
...
xs_dates = c("T2020_08_09", "T2020_11_01", "T2021_08_15")
...
<hr> #### "Within", "Between", and State-by-State Analysis
- link to [calculations](./ronaVote_appendix_within.html)
...
#### TODO
 * Color-code more
    - xs regression lines blue and white for dem and no-trend
    - dots gray on time-series plots when p>.05
 * Put captions on between/within plots with regression model
 * More discussion of between/within and state-by-state plot interpretations
 * Redo entire code leaving data in tall format instead of wide.
    - For clarity and conciseness.
    - I can view data in wide format, but return code to tall format only for the workflow.
    - Include the between-within into the main program
 * Get updated 2020 census data.
 * Make a big table of OLS / WLS / Within / Between coefficients at the three key-points.
 * Put the whole thing on Linode and make it automatically update itself with the latest COVID data.

#### DONE
 * Plot cases per 100,000 (cumulative and weekly-average-daily-rate) (2021-08-16)
 * Plot similar graphs for within-states and between-states coefficients over time. (2021-08-16)
 * Weighted regression (2021-08-15)
 * Redo analysis using per-100,000 statistics instead of per-capita (2021-08-08)
 * Bubble chart of cross sections at the four points with trendline (2021-08-08)
 * Put magnitude of effect in context of aggregate figures (2021-08-08)
